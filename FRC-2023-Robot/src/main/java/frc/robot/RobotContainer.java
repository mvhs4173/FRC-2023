...
public class RobotContainer {
  ...
  public RobotContainer() {
    SmartDashboard.putData(m_motor);
    m_motor.setDefaultCommand(new DefaultTeleop(m_motor, m_controller));
  ...
  private void configureBindings() {
    ...
    xButton.onTrue(new MotorSpin(m_motor).withTimeout(5));
  }
  ...
  /* public void getAutonomousCommand() {
    ...
    return MotorSpin.exampleAuto(m_exampleSubsystem);
  } */
}
